...
del dino.lst	REM dino可以替換成.asm檔的檔名
del dino.obj
del dino.ilk
del dino.pdb
del dino.exe
...
LINK /INCREMENTAL:no /debug /subsystem:console /entry:start /out:dino.exe dino.obj Kernel32.lib irvine32.lib user32.lib
if errorlevel 1 goto terminate
